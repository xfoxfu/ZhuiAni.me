...
namespace Me.Xfox.ZhuiAnime.Migrations
{
    ...
    [Migration("20230915185950_AllIdAsUlidStep3")]
    partial class AllIdAsUlidStep3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Me.Xfox.ZhuiAnime.Models.Item", b =>
                {
                    ...
                    b.HasIndex("CategoryIdV2")
                        .HasDatabaseName("ix_item_category_id_v2");

                    b.HasIndex("ParentItemIdV2")
                        .HasDatabaseName("ix_item_parent_item_id_v2");
            ...
            modelBuilder.Entity("Me.Xfox.ZhuiAnime.Models.Link", b =>
                {
                    ...
                    b.HasIndex("ItemIdV2")
                        .HasDatabaseName("ix_link_item_id_v2");

                    b.HasIndex("ParentLinkIdV2")
                        .HasDatabaseName("ix_link_parent_link_id_v2");
            ...
            modelBuilder.Entity("Me.Xfox.ZhuiAnime.Models.Session", b =>
                {
                    ...
                    b.HasIndex("UserIdV2")
                        .HasDatabaseName("ix_session_user_id_v2");
            ...
            modelBuilder.Entity("Me.Xfox.ZhuiAnime.Models.Item", b =>
                {
                    b.HasOne("Me.Xfox.ZhuiAnime.Models.Category", "Category")
                        .WithMany("Items")
                        .HasForeignKey("CategoryIdV2")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_item_category_category_temp_id");

                    b.HasOne("Me.Xfox.ZhuiAnime.Models.Item", "ParentItem")
                        .WithMany("ChildItems")
                        .HasForeignKey("ParentItemIdV2")
                        .HasConstraintName("fk_item_item_parent_item_temp_id");
            ...
            modelBuilder.Entity("Me.Xfox.ZhuiAnime.Models.Link", b =>
                {
                    b.HasOne("Me.Xfox.ZhuiAnime.Models.Item", "Item")
                        .WithMany("Links")
                        .HasForeignKey("ItemIdV2")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_link_item_item_temp_id1");

                    b.HasOne("Me.Xfox.ZhuiAnime.Models.Link", "ParentLink")
                        .WithMany("ChildLinks")
                        .HasForeignKey("ParentLinkIdV2")
                        .HasConstraintName("fk_link_link_parent_link_temp_id");
            ...
            modelBuilder.Entity("Me.Xfox.ZhuiAnime.Modules.PikPak.PikPakJob", b =>
                {
                    b.OwnsOne("Me.Xfox.ZhuiAnime.Modules.PikPak.PikPakJob+MatchGroups", "MatchGroup", b1 =>
                        {
                            b1.Property<Guid>("PikPakJobIdV2")
                                .HasColumnType("uuid")
                                .HasColumnName("id_v2");
                            ...
                            b1.HasKey("PikPakJobIdV2");

                            b1.ToTable("pikpak_job");

                            b1.WithOwner()
                                .HasForeignKey("PikPakJobIdV2")
                                .HasConstraintName("fk_pikpak_job_pikpak_job_id_v2");
                        });
