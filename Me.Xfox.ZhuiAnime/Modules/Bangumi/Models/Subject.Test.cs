...
""")
        .Should().BeEquivalentTo(new Subject
        {
            ...
            Infobox = new List<Item>
            {
                ...
                new Item("话数", "13"),
                new Item("放送开始", "2022年7月2日"),
                new Item("放送星期", "星期六"),
                new Item("官方网站", "https://lycoris-recoil.com/"),
                new Item("播放电视台", "TOKYO MX"),
                new Item("其他电视台", "BS11 / 群馬テレビ / とちぎテレビ"),
                new Item("Copyright", "©Spider Lily／アニプレックス・ABCアニメーション・BS11"),
                new Item("原作", "Spider Lily"),
                new Item("导演", "足立慎吾"),
                new Item("人物设定", "いみぎむる，辅助人设：山本由美子"),
                new Item("原画", "【主动画师：沢田犬二(澤田謙治)】"),
                new Item("美术监督", "冈本穗高、池田真依子"),
                new Item("企画", "岩上敦宏、西出将之、田﨑勝也"),
                new Item("总制片", "三宅将典；制作统括：柏田真一郎、加藤淳"),
                new Item("制片人", "神宮司学、吉田佳弘、大和田智之；动画制片人：中柄裕二"),
                new Item("脚本", "足立慎吾(1-2)、枦山大(3,7)、神林裕介(4)、鹿間貴裕(5-6)"),
                new Item("分镜", "足立慎吾(1,3)、三浦貴博(2)、丸山裕介(3)、竹内哲也(4)、鹿間貴裕(5-6)、柴田裕介(7)"),
                new Item("演出", "柴田裕介(1,7)、尾之上知久(2)、丸山裕介(3)、竹内哲也(4)、関暁子(5)、佐久間貴史(6)"),
                new Item("总作画监督", "山本由美子(1,6)、竹内由香里(2,5)、鈴木豪(3-4)、晶貴孝二(3-4,7)、森田莉奈(7)"),
                new Item("文芸協力", "枦山大、神林裕介")
            },
            Volumes = 0,
            Eps = 13,
            TotalEpisodes = 14,
