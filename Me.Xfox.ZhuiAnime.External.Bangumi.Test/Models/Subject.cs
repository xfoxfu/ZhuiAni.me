        ...
        JsonSerializer.Deserialize<Subject>(@"
{
    ...
    ""type"": 2
        ...
        ").Should().BeEquivalentTo(new Subject
        {
            ...
            {
                new Item { Key = "中文名", Value = new Item.StringItemValue { Value = "莉可丽丝" } },
                ...
                new Item { Key = "话数", Value = new Item.StringItemValue { Value = "13" }},
                new Item { Key = "放送开始", Value = new Item.StringItemValue { Value = "2022年7月2日" }},
                new Item { Key = "放送星期", Value = new Item.StringItemValue { Value = "星期六" }},
                new Item { Key = "官方网站", Value = new Item.StringItemValue { Value = "https://lycoris-recoil.com/" }},
                new Item { Key = "播放电视台", Value = new Item.StringItemValue { Value = "TOKYO MX" }},
                new Item { Key = "其他电视台", Value = new Item.StringItemValue { Value = "BS11 / 群馬テレビ / とちぎテレビ" }},
                new Item { Key = "Copyright", Value = new Item.StringItemValue { Value = "©Spider Lily／アニプレックス・ABCアニメーション・BS11" }},
                new Item { Key = "原作", Value = new Item.StringItemValue { Value = "Spider Lily" }},
                new Item { Key = "导演", Value = new Item.StringItemValue { Value = "足立慎吾" }},
                new Item { Key = "人物设定", Value = new Item.StringItemValue { Value = "いみぎむる，辅助人设：山本由美子" }},
                new Item { Key = "原画", Value = new Item.StringItemValue { Value = "【主动画师：沢田犬二(澤田謙治)】" }},
                new Item { Key = "美术监督", Value = new Item.StringItemValue { Value = "冈本穗高、池田真依子" }},
                new Item { Key = "企画", Value = new Item.StringItemValue { Value = "岩上敦宏、西出将之、田﨑勝也" }},
                new Item { Key = "总制片", Value = new Item.StringItemValue { Value = "三宅将典；制作统括：柏田真一郎、加藤淳" }},
                new Item { Key = "制片人", Value = new Item.StringItemValue { Value = "神宮司学、吉田佳弘、大和田智之；动画制片人：中柄裕二" }},
                new Item { Key = "脚本", Value = new Item.StringItemValue { Value = "足立慎吾(1-2)、枦山大(3,7)、神林裕介(4)、鹿間貴裕(5-6)" }},
                new Item { Key = "分镜", Value = new Item.StringItemValue { Value = "足立慎吾(1,3)、三浦貴博(2)、丸山裕介(3)、竹内哲也(4)、鹿間貴裕(5-6)、柴田裕介(7)" }},
                new Item { Key = "演出", Value = new Item.StringItemValue { Value = "柴田裕介(1,7)、尾之上知久(2)、丸山裕介(3)、竹内哲也(4)、関暁子(5)、佐久間貴史(6)" }},
                new Item { Key = "总作画监督", Value = new Item.StringItemValue { Value = "山本由美子(1,6)、竹内由香里(2,5)、鈴木豪(3-4)、晶貴孝二(3-4,7)、森田莉奈(7)" }},
                new Item { Key = "文芸協力", Value = new Item.StringItemValue { Value = "枦山大、神林裕介" }}
            },
            Volumes = 0,
            Eps = 13,
            TotalEpisodes = 14,
